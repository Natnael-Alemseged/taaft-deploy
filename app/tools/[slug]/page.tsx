          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm bg-[#f5f0ff] text-[#a855f7] px-3 py-1 rounded-full">{safeTool?.category}</span>
            ...
            <div className="md:col-span-1">
              <div className="border border-[#e5e7eb] rounded-lg p-6 sticky top-8">
                ...
                <div className="border-t border-[#e5e7eb] pt-4">
                  ...
                  <p className="text-sm text-[#6b7280]">{safeTool?.updatedAt ? new Date(safeTool.updatedAt).toLocaleDateString() : 'N/A'}</p>
                </div>

                <div className="flex items-center justify-between mt-8">
                  <button
                      className={`p-2 border border-[#e5e7eb] rounded-lg ${safeTool?.savedByUser ? "text-purple-600" : "text-gray-600"}`}
