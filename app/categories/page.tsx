...
export default function Categories() {
  ...
  if (isError) {
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col items-center justify-center text-red-600"> {/* Added dark mode */}
  ...
  if (!categoriesData || categoriesData.length === 0) {
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col items-center justify-center text-gray-600 dark:text-gray-400"> {/* Added dark mode */}
  ...
  return (
      <div className="min-h-screen bg-white dark:bg-gray-950"> {/* Added dark mode */}
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          {/* Page Title */}
          <h1 className="text-3xl font-bold text-[#111827] dark:text-white mb-1">All Categories</h1> {/* Added dark mode */}
          <p className="text-[#6b7280] dark:text-gray-400 mb-8"> {/* Added dark mode */}
