      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-purple-50 to-purple-100 py-24 text-center">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            ...
            {/* Headings */}
            {/* Modified H2 to include the overlapping circles */}
            <h1 className="text-4xl font-bold text-purple-500 md:text-5xl">AI Tools Discovery</h1>
            <h2 className="mb-6 text-5xl font-extrabold text-gray-900 md:text-6xl flex justify-center items-center"> {/* Added flex, justify-center, items-center */}
              Platform
              {/* Container for the overlapping circles */}
              <div className="relative inline-block w-10 h-10 ml-2 md:w-12 md:h-12 md:ml-3"> {/* Adjust size and margin as needed */}
                {/* First Circle */}
                <div className="absolute top-0 left-0 w-8 h-8 md:w-10 md:h-10 rounded-full bg-purple-500 opacity-75" style={{ transform: 'translate(15%, 15%)' }}></div> {/* Adjusted position and size */}
                {/* Second Circle */}
                <div className="absolute top-0 left-0 w-8 h-8 md:w-10 md:h-10 rounded-full bg-purple-400" style={{ transform: 'translate(-15%, -15%)' }}></div> {/* Adjusted color, position, and size */}
              </div>
            </h2>
