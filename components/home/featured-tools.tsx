            ...
            <div className="container mx-auto px-4">
                ...
                {isLoading && (
                    <div className="flex justify-center py-12">
                        <div
                            className="h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-purple-600"></div>
                    </div>
                )}
                                        ...
                                        <div className="mb-4 flex flex-wrap gap-2">
                                            {(tool.keywords || []).slice(0, 3).map((feature, index) => {
                                                ...
                                                return (
                                                    <span
                                                        key={index}
                                                        className={`rounded-md px-2 py-1 text-xs ${colorClass}`}
                                                    >
        {feature}
      </span>
                                                );
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                >
                                                    <Bookmark className="h-4 w-4"
                                                              fill={tool.savedByUser ? "currentColor" : "none"}/>
                                                </button>
                                                <button
