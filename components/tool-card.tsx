...
export default function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    ...
    //         {/* --- Render the ShareButtonWithPopover Component here --- */}
    //         {/* Pass the toolLinkHref (link to the tool's detail page) as the itemLink prop */}
    //         <ShareButtonWithPopover itemLink={toolLinkHref} />
    //         {/* ---------------------------------------------------------- */}
    //       </div>
